...
import com.dubu.backend.todo.api.TodoApi;
...
public interface ShareApi {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200",
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(
                                    implementation = SurroundingMembersWithRankResponse.class,
    ...
    SuccessResponse<?> getSurroundingMembers(
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200",
                    ...
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(
                                    implementation = SurroundingMemberResponse.class,
                                    description = "지도(공유) 성공 응답"
                            ),
                            examples = {
                                    @ExampleObject(
    ...
    SuccessResponse<?> getSurroundingMemberTodos(
            @RequestAttribute Long memberId,
            @Schema(description = "주변 회원 ID" ,example = "12345") @RequestParam Long surroundingMemberId
    );
    ...
    void deleteFromFavorites(
            @RequestAttribute Long memberId,
            @Schema(description = "주변 회원 ID" ,example = "12345") @RequestParam Long surroundingMemberTodoId
    );
}
