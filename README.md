...
| **분야** | **이름** | **포지션** | **내용** |
| --- | --- | --- | --- |
| 기획 | 오예은 | 📈 서비스 기획 | 유저 리서치, 와이어프레임 및 디스크립션, 서비스 정책 수립 |
| 기획 | 이정수 | 📋 서비스 기획 | 유저 리서치, 와이어프레임 및 디스크립션, 서비스 정책 수립 |
| 디자인 | 서가영 | 🎨 기획&디자인 리드 | UI/UX디자인, GUI 디자인, 모션그래픽 |
| 디자인 | 최예지 | 🎨 디자인 | UI/UX디자인, GUI 디자인 |
| 개발 | 박규한 | 📱 프론트엔드 | 할 일, 지도, 모바일 드래그 앤 드롭, 에러 핸들링, Headless UI, 배포 자동화 |
| 개발 | 손영진 | 📱 프론트엔드 | OAuth 로그인, 온보딩, 경로 선택, 피드백, 통계화면, PWA, 푸시알람 |
| 개발 | 문희상 | 💻 개발 리드 | ERD 설계, 로그인 및 인증, 회원, 알림, 경로 및 계획, CI/CD |
| 개발 | 김현원 | 💻 백엔드 | ERD 설계, 할 일(Todo), 통계, 지도(공유) |
